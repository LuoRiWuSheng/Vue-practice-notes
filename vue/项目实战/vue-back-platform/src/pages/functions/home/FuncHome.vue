<template>
   <div>
        ...
        <!-- 散点图 -->
        <el-row :gutter='20' class='scatter-plot'>
            <el-col :span='24' :xs='24' :sm='24' :md='24' :lg='24'>
                <el-card>
                    <ve-scatter :data='scatterPlot'></ve-scatter>
                </el-card>
            </el-col>
        </el-row>
   </div>
...
export default {
    ...
    data () {
        return {
            ...
            scatterPlot: { // 多维度多指标的散点图 -- 就是一个指标包含多种数据（'日期', '访问用户', '下单用户', '年龄'）
                columns: ['日期', '访问用户', '下单用户', '年龄'],
                rows: {
                    '上海': [
                        {'日期': '1/1', '访问用户': 123, '下单用户': 700, '年龄': 10},
